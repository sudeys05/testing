...
const Dashboard = ({ onAddCaseClick, onLicensePlateClick, cases }) => {
  ...
  const stats = [
    { title: 'Open Cases', value: openCases.toString(), change: '+2 from last week', color: 'orange', icon: FileText },
    { title: 'In Progress', value: inProgressCases.toString(), change: '+1 from last week', color: 'blue', icon: Clock },
    { title: 'Closed Cases', value: closedCases.toString(), change: '+5 from last week', color: 'green', icon: CheckCircle },
    { title: 'Priority Cases', value: priorityCases.toString(), change: '+1 from last week', color: 'red', icon: AlertTriangle }
  ];
